...
public class ConstAssignChars extends ConstAssignops {

    private ConstAssignops ConstAssignops;
    private String constName;
    private Character constVal;

    public ConstAssignChars (ConstAssignops ConstAssignops, String constName, Character constVal) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstAssignChars(\n");
