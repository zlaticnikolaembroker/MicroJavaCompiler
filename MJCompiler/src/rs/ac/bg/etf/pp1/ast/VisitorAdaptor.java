...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(RelopNotIdentical RelopNotIdentical) { visit(); }
    public void visit(RelopIdentical RelopIdentical) { visit(); }
    ...
    public void visit(TernaryTwo TernaryTwo) { visit(); }
    public void visit(TernaryOne TernaryOne) { visit(); }
    ...
    public void visit(MultupleArray MultupleArray) { visit(); }
